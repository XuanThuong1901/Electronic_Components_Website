...
const ReturnOrderDetailAdmin = () => {
  ...
  const getReturnOrdersDetail = async () => {
    const res = await api.get(`/admin/return_order/${id}`, {
      headers: {
        access_token: token,
      },
    });
  ...
  const HandleStatus = (status) => {
    if (item.status === "confirmed" || item.status === "refuse") {
      ...
      try {
        api
          .get(`/admin/return_order/confirmed/${item.id}/${status}`, {
            headers: {
              access_token: token,
            },
          })
          ...
          <div className="row">
            ...
            <div className="col-12 col-md-6">
              <div className={classes["payment__method"]}>
                ...
                {item.status === "unconfirmed" && <div className={classes["button-review"]}>
                  <button
...
export default ReturnOrderDetailAdmin;
